...
# While loop menu with list pakuri, show pakuri, add pakuri, evolve pakuri, sort pakuri
# and exit
    while True:
        print("\nPakudex Main Menu\n-----------------")
        print("1. List Pakuri\n2. Show Pakuri\n3. Add Pakuri\n4. Evolve Pakuri\n5. Sort Pakuri\n6. Exit\n")
        ...
        # Displays the stats of the species you entered, and displaying an error if it
        # doesn't exist
        elif choice == 2:
        ...
        # Add your own Pakuri into the Pakudex, displaying messages if the Pakudex is
        # full or if the species already exists
        elif choice == 3:
